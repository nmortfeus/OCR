...
#include "../../image_treatment/image_to_bin/image_to_bin.h"
#include "../../image_treatment/detections/process.h"
#include "../../image_treatment/detections/Letter.h"
#include "../../neural_network/chars_reco/neural_network.h"
#include "../../image_treatment/display.h"
#include "sdl2gtk.h"
...
static void UI_NextStep()
{
    switch(currentStep)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            big_brain(letters, grid_letters_index, nb_grid_letters, list_letters_index, nb_list_letters, &col, &found);
